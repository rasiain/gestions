...
D'aquí surt, de franc, la descomposició que abans s'havia de fer a mà: **variació del total − net dels fluxos = rendiment de mercat**, que la taula de detall dona període a període al costat de la variació. Comprovat contra un càlcul independent del 2026: els fluxos donen −63.204 € i el camí de l'estoc donava −63.182 €; els 22 € de diferència són la revaloració del capital social, que és canvi de valor i no cap flux.

Sobre un rang sencer, el tram ha de ser el mateix a banda i banda: la variació va del **final** del primer període al final de l'últim, de manera que els fluxos d'aquell primer període són anteriors al punt de partida i **no hi entren**. Sumar-los tots donava disbarats —amb el rang 2023-2026, −87.452 € en comptes de +90.163 €— i per això el peu diu el tram que cobreix («Mercat 2024–2026»).
